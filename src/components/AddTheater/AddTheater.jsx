...
const AddTheater = () => {
  ...
  const handleNseats = (number) => {
    ...
    setTheater((prev) => ({ 
      ...
      booleanArrays: { ...prev.booleanArrays, n: [...prev.booleanArrays.n, !prev.seat.n[number]] }
    }));
  }
  ...
  const handlePseats = (number) => {
    ...
    setTheater((prev) => ({
      ...
      booleanArrays: { ...prev.booleanArrays, p: [...prev.booleanArrays.p, !prev.seat.p[number]] }
    }));
  }
  ...
  const handleDseats = (number) => {
    ...
    setTheater((prev) => ({
      ...
      booleanArrays: { ...prev.booleanArrays, d: [...prev.booleanArrays.d, !prev.seat.d[number]] }
    }));
  }
